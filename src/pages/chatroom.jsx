...
const ChatRoom = () => {
    ...
    return (
        <div
        class="w-screen min-h-screen flex items-center  justify-center bg-[#010e28] bg-[linear-gradient(to_bottom,_#082740_1px,_transparent_1px),_linear-gradient(to_right,_#082740_1px,_transparent_1px)] [background-size:30px_30px] bg-center overflow-x-hidden animate-bgmove">
            {!joined ? (
                ...
                <div className="flex flex-col h-screen w-full max-w-2xl bg-white shadow-lg rounded-lg overflow-hidden">
